...
export const ConfirmationModal = props => {
  ...
  return (
    <Modal open={props.show} onClose={props.onClose}>
      <Fade in={true}>
        <Backdrop open style>
          <Paper className="doge-card doge-modal" style={{ maxWidth: "450px" }}>
            ...
            <Box className="card-content pool-deposit-confirmation">
              ...
              <Box display="flex" className="swap-icons">
                <Box className="pool-deposit-confirmation">
                  <SvgIcon component={DogesTokenImg} viewBox="0 0 100 100" className="swap-icon-size" />
                </Box>
              ...
              <Typography variant="body2" className="info-text">
                You're depositing <strong>{props.quantity} Doges </strong>in the
              ...
              <Typography variant="body2" className="info-text">
                <em>
                  ...
                  normal DOGEs rebase reward and that it will instead go directly into funding the prize pool.
                </em>
              </Typography>
              <Typography variant="body2" className="info-text">
