...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({ children }) => {
  ...
  const [chainID, setChainID] = useState(56);  // ychm mainnet chain id
  const [address, setAddress] = useState("");

  const [uri, setUri] = useState("https://speedy-nodes-nyc.moralis.io/1b8e53affad7184a2e65e738/bsc/mainnet");
    ...
    new Web3Modal({
      ...
      providerOptions: {
        walletconnect: {
          ...
          options: {
            rpc: {
              56: "https://speedy-nodes-nyc.moralis.io/1b8e53affad7184a2e65e738/bsc/mainnet",
              250: "https://speedy-nodes-nyc.moralis.io/75d81e57f4b08a8d8ecc85a5/fantom/mainnet",
              4002: getTestnetURI(),
            },
          },
        },
  ...
  const _checkNetwork = (otherChainID: number): boolean => {
    if (chainID !== otherChainID) {
      ...
      if (otherChainID === 56 || otherChainID === 4002) {
        setChainID(otherChainID);
        otherChainID === 56
          ? setUri("https://speedy-nodes-nyc.moralis.io/1b8e53affad7184a2e65e738/bsc/mainnet")
